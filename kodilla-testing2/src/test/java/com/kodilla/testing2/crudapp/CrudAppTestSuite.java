...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://UserWeronikaGarbarz.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("weronika.garbarz@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Weronika1");
        ...
        webDriver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(t -> {
                    WebElement buttonDeleteCard =
                            t.findElement(By.xpath(".//button[4]"));
