...
public class ForumTestSuite {
    ...
    public void beforeEveryTest() {
        ...
        testCounter++; // number of the test
        System.out.println("Preparing to execute test #" + testCounter);
    }

    @Test //checking if after adding one post their amount is one
    public void testAddPost() {

        // Given
        ForumUser forumUser = new ForumUser("eRiK", "mrsmith", "John Smith");
    ...
    @Test //checking if after adding one comment their amount is one
    ...
    @Test //checking if the got post is the same as the given post
    ...
    @Test //checking if the got comment is the same as the given comment
    ...
    @Test //deleting post from the class
    ...
    @Test //deleting comment from the class
